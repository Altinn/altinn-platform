...
* *az* CLI tool is installed.
* Ensure the you has subscription IAM roles:
    * *Owner*
    * Combination of *Contributor* and *User Access Administrator*.
* Ensure the user has permissions to create AD groups and app registrations.
  
### Configure Variables
* Make any necessary changes to *variables.tfvars* before deploying the project. Default configuration for *variables.tfvars*:
```terraform
environments = [
  {
    name = "dev"
