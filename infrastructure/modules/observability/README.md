...
| <a name="input_monitor_workspace_id"></a> [monitor\_workspace\_id](#input\_monitor\_workspace\_id) | When reusing AMW, pass its ID and Name (avoids lookups). | `string` | `null` | no |
