...
import (
	...
	"github.com/Altinn/altinn-platform/services/dis-promrulegroups-operator/test/utils"
)

// namespace where the project is deployed in
const namespace = "dis-promrulegroups-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "dis-promrulegroups-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "dis-promrulegroups-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "dis-promrulegroups-operator-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=dis-promrulegroups-operator-metrics-reader",
