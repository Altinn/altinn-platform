...
func (in *PasswordRotationSpec) DeepCopyInto(out *PasswordRotationSpec) {
	*out = *in
	...
	if in.PreviousValidFor != nil {
		in, out := &in.PreviousValidFor, &out.PreviousValidFor
		*out = new(v1.Duration)
		**out = **in
	}
}
...
func (in *PasswordRotationStatus) DeepCopyInto(out *PasswordRotationStatus) {
	*out = *in
	...
	if in.PreviousValidUntil != nil {
		in, out := &in.PreviousValidUntil, &out.PreviousValidUntil
		*out = (*in).DeepCopy()
	}
}
